...
public class WorldGenAlienFlowers extends WorldGenerator {
    ...
    public boolean generate(World worldIn, Random rand, BlockPos position) {
        for (int i = 0; i < 64; ++i) {
            ...
            if (worldIn.isAirBlock(blockpos) && (worldIn.provider.hasSkyLight() || blockpos.getY() < 255) && MatterOverdrive.BLOCKS.alienFlower.canBlockStay(worldIn, blockpos, this.flowerBlockState)) {
