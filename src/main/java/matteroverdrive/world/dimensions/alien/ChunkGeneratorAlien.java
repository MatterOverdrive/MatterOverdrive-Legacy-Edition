...
public class ChunkGeneratorAlien implements IChunkGenerator {
    ...
    public void setBlocksInChunk(int p_180518_1_, int p_180518_2_, ChunkPrimer p_180518_3_) {
        this.biomesForGeneration = this.world.getBiomeProvider().getBiomesForGeneration(this.biomesForGeneration, p_180518_1_ * 4 - 2, p_180518_2_ * 4 - 2, 10, 10);
    ...
    public void replaceBlocksForBiome(int p_180517_1_, int p_180517_2_, ChunkPrimer p_180517_3_, Biome[] p_180517_4_) {
        net.minecraftforge.event.terraingen.ChunkGeneratorEvent.ReplaceBiomeBlocks event = new net.minecraftforge.event.terraingen.ChunkGeneratorEvent.ReplaceBiomeBlocks(this, p_180517_1_, p_180517_2_, p_180517_3_, this.world);
        ...
        for (int k = 0; k < 5; ++k) {
            for (int l = 0; l < 5; ++l) {
                ...
                for (int l1 = 0; l1 < 33; ++l1) {
                    ...
                    double clampedNoiseValue = MathHelper.clampedLerp(lowerNoiseValue, upperNoiseValue, noiseValue) - d1;
    ...
    public void populate(int p_73153_2_, int p_73153_3_) {
        ...
        this.rand.setSeed((long) p_73153_2_ * k + (long) p_73153_3_ * l ^ this.world.getSeed());
        boolean flag = false;

        net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.event.terraingen.PopulateChunkEvent.Pre(this, world, rand, p_73153_2_, p_73153_3_, flag));

        if (this.settings.useWaterLakes && !flag && this.rand.nextInt(this.settings.waterLakeChance) == 0
                && net.minecraftforge.event.terraingen.TerrainGen.populate(this, world, rand, p_73153_2_, p_73153_3_, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.LAKE)) {
        ...
        if (!flag && this.rand.nextInt(this.settings.lavaLakeChance / 10) == 0 && this.settings.useLavaLakes &&
                net.minecraftforge.event.terraingen.TerrainGen.populate(this, world, rand, p_73153_2_, p_73153_3_, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.LAVA)) {
        ...
        if (net.minecraftforge.event.terraingen.TerrainGen.populate(this, world, rand, p_73153_2_, p_73153_3_, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.ANIMALS)) {
            WorldEntitySpawner.performWorldGenSpawning(this.world, biomegenbase, i + 8, j + 8, 16, 16, this.rand);
        }
        blockpos = blockpos.add(8, 0, 8);

        boolean doGen = net.minecraftforge.event.terraingen.TerrainGen.populate(this, world, rand, p_73153_2_, p_73153_3_, flag, net.minecraftforge.event.terraingen.PopulateChunkEvent.Populate.EventType.ICE);
        ...
        net.minecraftforge.common.MinecraftForge.EVENT_BUS.post(new net.minecraftforge.event.terraingen.PopulateChunkEvent.Post(this, world, rand, p_73153_2_, p_73153_3_, flag));
