...
public class AndroidHudMinimap extends AndroidHudElement {
    ...
    private void drawBackground(ScaledResolution resolution) {
        ...
        double radarPercent = (mc.world.getWorldTime() % AndroidPlayer.MINIMAP_SEND_TIMEOUT) / (double) AndroidPlayer.MINIMAP_SEND_TIMEOUT;
    ...
    private Color getMinimapColor(EntityLivingBase entityLivingBase) {
        ...
        } else if (entityLivingBase instanceof IMerchant || entityLivingBase.isOnSameTeam(Minecraft.getMinecraft().player)) {
