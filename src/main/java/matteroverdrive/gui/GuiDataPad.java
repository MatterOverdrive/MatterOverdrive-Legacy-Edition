...
public class GuiDataPad extends MOGuiBase {
    ...
    public void registerPages(MOBaseContainer container) {
        ...
        activeQuests = new PageActiveQuests(this, 0, 0, xSize - 28, ySize - 28, "Active Quests", MOPlayerCapabilityProvider.GetExtendedCapability(Minecraft.getMinecraft().player));
